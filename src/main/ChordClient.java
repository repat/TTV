...
//        System.out.println("PredecessorID: " + chordImpl.getPredecessorID());
    ...
    // Man schießt noch auf sich selber, aber geht das irgendwie in die richtige Richtung?
    private static void shoot(String sektor) {
        ...
        if (chordImpl.retrieve(key).size() > 0) {
            ...
            System.out.println("Schiff in Sektor " + sektor + " getroffen!");
            chordImpl.broadcast(chordImpl.getID(), Boolean.TRUE); // Broadcast wird noch nicht ausgewertet
        } else {
